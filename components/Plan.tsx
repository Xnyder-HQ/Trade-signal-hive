    ...
    return( 
        <div>
            ...
            <div className="justify-center items-center">
                <h2 className={`text-4xl font-bold text-center ${spaceGrotesk.className}`}>Simple Transparent <br /> and Flexble Pricing for Everyone</h2>
                <p className={`pricing ${inter.className}`}>Select the perfect plan for your investing journey - Transparent Pricing no <br /> hidden fees just smarter trader</p>
            </div>
               ...
               <div className="box1 flex flex-col justify-between h-full bg-[#0a0a0a] border border-[#27272a] rounded-[30px] p-8 w-[380px]">
                <div>
                    ...
                    <ul className="space-y-4 mb-8">
                        <li className={`flex items-center text-gray-300 text-sm ${inter.className}`}><span className="mr-3 text-gray-500"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" fill="#27272a" /><path d="M8 12L11 15L16 9" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></span> All Pro Features</li>
                        <li className={`flex items-center text-gray-300 text-sm ${inter.className}`}><span className="mr-3 text-gray-500"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" fill="#27272a" /><path d="M8 12L11 15L16 9" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></span> VIP webinars & tutorials</li>
                        <li className={`flex items-center text-gray-300 text-sm ${inter.className}`}><span className="mr-3 text-gray-500"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" fill="#27272a" /><path d="M8 12L11 15L16 9" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></span> AI-powered portfolio suggestions</li>
                    </ul>
                </div>
              ...
              <div className="box2 flex flex-col justify-between h-full bg-linear-to-b from-[#111827] to-[#0a0a0a] border border-[#1f2937] rounded-[30px] p-8 w-[380px] relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <ul className="space-y-4">
                        <li className={`flex items-start text-gray-300 text-sm ${inter.className}`}><span className="mr-3 mt-1 min-w-[20px]"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M2 17L12 22L22 17" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M2 12L12 17L22 12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></span> <span><span className="text-white font-medium">Advanced market</span> analytics provides insights for smarter investment decisions</span></li>
                        <li className={`flex items-start text-gray-300 text-sm ${inter.className}`}><span className="mr-3 mt-1 min-w-[20px]"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17 21V19C17 17.9391 16.5786 16.9217 15.8284 16.1716C15.0783 15.4214 14.0609 15 13 15H5C3.93913 15 2.92172 15.4214 2.17157 16.1716C1.42143 16.9217 1 17.9391 1 19V21" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M9 11C11.2091 11 13 9.20914 13 7C13 4.79086 11.2091 3 9 3C6.79086 3 5 4.79086 5 7C5 9.20914 6.79086 11 9 11Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M23 21V19C22.9993 18.1137 22.7044 17.2528 22.1614 16.5523C21.6184 15.8519 20.8581 15.3516 20 15.13" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M16 3.13C16.8604 3.35031 17.623 3.85071 18.1676 4.55232C18.7122 5.25392 19.0078 6.11683 19.0055 7.003C19.0033 7.88917 18.7032 8.75024 18.1554 9.44976C17.6075 10.1493 16.8431 10.647 15.98 10.87" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></span> <span><span className="text-white font-medium">Join and connect</span> with investors to grow wealth together</span></li>
                        <li className={`flex items-start text-gray-300 text-sm ${inter.className}`}><span className="mr-3 mt-1 min-w-[20px]"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M21 12V7H5V12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M21 16V12H5V16" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M21 21H5V16H21V21Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M21 7V3H5V7" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></span> <span>Create and manage <span className="text-white font-medium">unlimited watchlists</span> for smarter market tracking</span></li>
                        <li className={`flex items-start text-gray-300 text-sm ${inter.className}`}><span className="mr-3 mt-1 min-w-[20px]"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 8C19.6569 8 21 6.65685 21 5C21 3.34315 19.6569 2 18 2C16.3431 2 15 3.34315 15 5C15 6.65685 16.3431 8 18 8Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M2 17V22H22V17" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M2 17H22" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M12 17V12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M2 12H22" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M6 12V8C6 6.34315 7.34315 5 9 5" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></span> <span>Track market movements with instant alerts for smarter decisions</span></li>
                    </ul>
                </div>
              </div>
